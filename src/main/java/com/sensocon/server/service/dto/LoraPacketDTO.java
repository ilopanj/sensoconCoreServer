...
public class LoraPacketDTO implements Serializable {
    ...
    public void setDeviceId(Long sensorDeviceId) {
    ...
    public void setDeviceDeviceId(String sensorDeviceDeviceId) {
        this.deviceDeviceId = sensorDeviceDeviceId;
    }
